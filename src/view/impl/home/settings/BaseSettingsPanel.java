...
public class BaseSettingsPanel extends JPanel implements PropertyChangeListener {
    ...
    protected void applyScalingBasedOnCurrentDimensions() {
        ...
        // Calculate font size for panels (Music, Sound Effects)
    ...
    private void setupLayout() {
        ...
        gbc.anchor = GridBagConstraints.WEST; // Left anchor for panels
        ...
        musicSoundButton.setContentAreaFilled(false); // Hide the buttons's fill area
        ...
        musicVolumeSlider.setPaintLabels(true); // Draw tick panels
        gbc.gridx = 2;
        ...
        gbc.anchor = GridBagConstraints.CENTER; // Center the buttons panel
        gbc.fill = GridBagConstraints.NONE; // Don't fill the space
    ...
    // Update the audio buttons icon based on the slider value
...
// ----------------------------------------OVERRIDE METHODS-------------------------------------------------------------
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if ("musicVolume".equals(evt.getPropertyName())) {
            ...
            // Update the audio buttons icon based on the new slider value
            updateSoundIcon(musicVolumeSlider, musicSoundButton);
