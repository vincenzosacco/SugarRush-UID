 ...
 */
class MapParser {
    final static String MAP_1 = "/maps/map1.txt";
    final static String MAP_2 = "/maps/map2.txt";
    final static String MAP_3 = "/maps/map3.txt";
    final static String MAP_4 = "/maps/map4.txt";
    final static String MAP_5 = "/maps/map5.txt";
    final static String MAP_6 = "/maps/map6.txt";
    /**
